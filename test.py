...
fig, axes = pyplot.subplots(
    3, 3, figsize=(20, 20), gridspec_kw={'height_ratios': [4, 1, 1]}
)
pyplot.subplots_adjust(wspace=0.1, hspace=0.05)

# Colormap
cm_lin = cm.get_cmap('gray_r')
cm_lin.set_bad('#E20134')

# Load data
f = 'jw01571172001_02201_00001_nis_rate_flatfield.fits'
exts = ['', '_crds', '_custom']
titles = 'No Background Subtraction', 'CRDS Background Subtraction', 'Custom Background Subtraction'
